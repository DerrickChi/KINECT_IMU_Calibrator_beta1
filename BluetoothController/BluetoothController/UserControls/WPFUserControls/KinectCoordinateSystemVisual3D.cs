...
namespace BluetoothController.WPFUserControls
{
    ...
    /// </summary>
   public class KinectCoordinateSystemVisual3D : ModelVisual3D
    {
        /// <summary>
        ...
        public static readonly DependencyProperty ArrowLengthsProperty = DependencyProperty.Register(
            "ArrowLengths",
            typeof(double),
            typeof(KinectCoordinateSystemVisual3D),
        ...
        public static readonly DependencyProperty XAxisColorProperty = DependencyProperty.Register(
            ...
            typeof(Color),
            typeof(KinectCoordinateSystemVisual3D),
            new UIPropertyMetadata(Color.FromRgb(152, 152, 152)));
        ...
        public static readonly DependencyProperty YAxisColorProperty = DependencyProperty.Register(
            ...
            typeof(Color),
            typeof(KinectCoordinateSystemVisual3D),
            new UIPropertyMetadata(Color.FromRgb(30, 187, 238)));
        ...
        public static readonly DependencyProperty ZAxisColorProperty = DependencyProperty.Register(
            ...
            typeof(Color),
            typeof(KinectCoordinateSystemVisual3D),
            new UIPropertyMetadata(Color.FromRgb(68, 35, 80)));

        /// <summary>
        /// Initializes a new instance of the <see cref = "KinectCoordinateSystemVisual3D" /> class.
        /// </summary>
        public KinectCoordinateSystemVisual3D ()
        {
        ...
        {
            ((KinectCoordinateSystemVisual3D)obj).OnGeometryChanged();
        }
